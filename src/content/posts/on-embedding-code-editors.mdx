...
- <input type="checkbox">Use a code editor that supports syntax highlighting</input>
- <input type="checkbox">Maybe hold off evaluating until a button is pressed</input>
- <input type="checkbox">I'll want to be able to share state between multiple instances on the same page (a la Jupyter Notebooks)</input>
- <input type="checkbox">Maybe render things like React/Vue/Svelte components</input>
